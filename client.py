...
def call_join(root, local_page, widget_destroy, image_frame, button_style, home_page, isHost, sound_option):
    ...
    def start(ip):
        ...
        if len(ip) == 0:
            ip = ipaddress
        # print("from start=",ip)
        call_join_start(root, local_page, call_join, widget_destroy, home_page, image_frame, selected_playersize, selected_gridSize, button_style, isHost, ip, sound_option)
