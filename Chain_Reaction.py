...
def home_page():
    ...
    offline_button = ttk.Button(button_frame, text="Offline",
                                style='W.TButton', command=offline_page)
...
def local_page():
    ...
    back_button = ttk.Button(button_frame, text="Back", style='W.TButton', command=home_page)
...
def settings_page():
    ...
    sound_button = ttk.Checkbutton(button_frame, text='Sound', style='W.TCheckbutton',
                                   command=lambda: print(play_sound.get()),
                                   variable=play_sound, onvalue="True", offvalue="False")
