...
def mainScreen(root, home_page, image_frame, button_style):
    ...
    text = ttk.Label(player_seclection_frame, text="No of Players: ", style="W.TLabel")
    ...
    text = ttk.Label(player_seclection_frame, text="Grid Size: ", style="W.TLabel")
    ...
    back_btn = ttk.Button(
        start_button_frame, text="Back", style="W.TButton", command=lambda: home_page()
    )
